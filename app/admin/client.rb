ActiveAdmin.register Client do
  ...
  show do
    panel 'Client Details' do
      attributes_table_for client do
        ...
        row :last_name
        row :phone_number
        row :next_court_date_at if feature_flag_for('court_dates')
        row :id_number if feature_flag_for('client_id_number')
      end
    end
  ...
  form do |f|
    f.inputs 'Client Info' do
      ...
      f.input :next_court_date_at if feature_flag_for('court_dates')
      f.input :id_number if feature_flag_for('client_id_number')
