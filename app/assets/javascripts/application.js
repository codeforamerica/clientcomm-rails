...
var followUpQuestion = (function() {
  var fUQ = {
    init: function() {
      // if any initial questions are already selected on page load,
      // show the follow up
      $('.question-with-follow-up__question')
        .find('.radio-button, .checkbox')
        .each(function(index, button) {
          if (
            $(this)
              .find('.question-with-follow-up__question input')
              .is(':checked') &&
            $(this).attr('data-follow-up') !== null
          ) {
      ...
      $('.question-with-follow-up').each(function(index, question) {
        ...
        // show the follow up
        $(self)
          .find('.question-with-follow-up__question')
          .find('.radio-button, .checkbox')
          .each(function(index, button) {
            if (
        ...
        $(self)
          ...
          .click(function(e) {
            // reset follow ups
            $(self)
              .find('.question-with-follow-up__follow-up input')
              .attr('checked', false);
            $(self)
              .find('.question-with-follow-up__follow-up')
              .find('.radio-button, .checkbox')
