IntercomRails.config do |config|
  ...
  config.user.custom_data = {
    ...
    in_treatment_group: proc { |user| user.try(:in_treatment_group) || false }
  }
  ...
  config.company.current = proc { { company_id: ENV['DEPLOYMENT'], name: ENV['DEPLOYMENT'] } }
  ...
  # open the messenger
  config.inbox.custom_activator = '.intercom-activate'
  #
