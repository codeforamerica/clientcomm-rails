...
describe Department, type: :model do
  ...
  describe '#message_metrics' do
    ...
    let!(:transfers1) { create_list :message, 2, send_at: now - 1.day, type: Message::MARKER_TRANSFER, reporting_relationship: user1.reporting_relationships.active.sample }
    ...
    let!(:transfers2) { create_list :message, 2, send_at: now - 1.day, type: Message::MARKER_TRANSFER, reporting_relationship: user2.reporting_relationships.active.sample }
